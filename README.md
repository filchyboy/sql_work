...
- How many of each specific subclass? Cleric 75, Fighter 68, Mage 108, Neromancer 11, Thief 51
- How many total Items? 174
- How many of the Items are weapons? How many are not? 37 weapons, 137 are not weapons.
- How many Items does each character have? (Return first 20 rows) 1	119	3
2	49	2
3	35	7
4	81	7
5	19	9
